...
function IframePlayer({ sources, onNext, onPrev, hasNext, hasPrev, title, onTimeUpdate }: Props) {
...
function HlsPlayer({ tmdbId, title, poster, sources, onNext, onPrev, hasNext, hasPrev, onTimeUpdate }: Props) {
